...
describe('jsonBuilder decorator', () => {
    it('should return encrypted JSON string', () => {
        ...
        // then
        expect(encryptableJsonBuilder.build(givenData)).toEqual(JSON.stringify(expectedData));
    });
    ...
    it('should return encrypted JSON string with wrapped structure', () => {
        ...
        const encryptableJsonBuilder = new EncryptableJsonBuilder(wrappedJsonBuilder);
        ...
        // then
        expect(encryptableJsonBuilder.build(givenData)).toEqual(JSON.stringify(expectedWrappedData));
    });
});