...
describe('[Builder] CustomerBuilder', () => {
  it('should build a customer to JSON with simple data', () => {
    ...
    expect(customerData).toEqual(
      '{"firstName":"John","lastName":"Doe","telNo":"555-555-5555"}'
    );
  });
  ...
  it('should build a customer to JSON with more optional data', () => {
    ...
    const customerData = customerBuilder
      ...
      .build();
    expect(customerData).toEqual(
      '{"firstName":"John","lastName":"Doe","telNo":"555-555-5555","address":{"street":"123 Main St.","city":"Anytown","state":"TX","zip":"12345"}}'
    );
  });
});
