...
describe('orderPizza from pizza store', () => {
    it('should return an Italian pizza', () => {
        ...
        const order = new PizzaOrder(PizzaStyle.Italian, PizzaType.Classic, PizzaSize.Small);
    ...
    it('should return an Italian cheese pizza', () => {
        const pizzaStore = new PizzaStore();
        const order = new PizzaOrder(PizzaStyle.Italian, PizzaType.Cheese, PizzaSize.Small); 
        const pizza = pizzaStore.orderPizza(order);
    ...
    it('should return an American seafood pizza', () => {
        const pizzaStore = new PizzaStore();
        const order = new PizzaOrder(PizzaStyle.American, PizzaType.Seafood, PizzaSize.Small);
        const pizza = pizzaStore.orderPizza(order);
